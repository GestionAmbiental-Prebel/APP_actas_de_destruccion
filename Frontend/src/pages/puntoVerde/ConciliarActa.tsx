...
// 🔹 Mock para cargar datos de acta
const mockActas = [
  {
    id: 1,
    nombre: "Juan Pérez",
    cedula: "123456789",
    residuos: [
      { nombre: "Papel", peso: 12 },
      { nombre: "Plástico", peso: 7 },
    ],
  },
];
...
export const ConciliarActa = () => {
  ...
  const pesoOriginal = acta.residuos.reduce((acc, r) => acc + r.peso, 0);

  return (
    <div className="max-w-3xl mx-auto p-6 font-acidGrotesk">
      <h2 className="text-2xl font-bold mb-6 text-skyBlue dark:text-lightBlue text-center">
        Conciliar Acta #{acta.id}
      </h2>

      {/* Info del acta */}
      <div className="bg-lightBlue/10 dark:bg-gray-800 p-4 rounded-lg mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-col">
          <label className="mb-1 font-medium text-skyBlue dark:text-lightBlue">Documento conciliador</label>
          <input
            type="text"
        ...
        <div className="flex flex-col">
          <label className="mb-1 font-medium text-skyBlue dark:text-lightBlue">Peso conciliado (kg)</label>
          <input
            type="number"
